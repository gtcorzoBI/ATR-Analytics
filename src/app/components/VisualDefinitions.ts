...
export const VISUAL_DEFINITIONS: Record<string, VisualDef> = {
  ...
  'area': { id: 'area', label: 'Área', iconType: 'LayoutDashboard', slots: [ {id: 'xAxis', label: 'Eje X', type: 'category'}, {id: 'yAxis', label: 'Eje Y', type: 'value'}, {id: 'legend', label: 'Leyenda', type: 'series'}, {id: 'smallMultiples', label: 'Múltiplos', type: 'category'}, {id: 'tooltips', label: 'Tooltips', type: 'value'} ] },
  ...
  'scatter': { id: 'scatter', label: 'Dispersión', iconType: 'Circle', slots: [ {id: 'xAxis', label: 'Eje X', type: 'value'}, {id: 'yAxis', label: 'Eje Y', type: 'value'}, {id: 'details', label: 'Valores (ID)', type: 'category'}, {id: 'legend', label: 'Leyenda (Color)', type: 'series'}, {id: 'size', label: 'Tamaño', type: 'value'}, {id: 'tooltips', label: 'Tooltips', type: 'value'} ] },
